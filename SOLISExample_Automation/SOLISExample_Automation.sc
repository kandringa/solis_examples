...
BEGIN Scenario
    ...
    BEGIN Interval
        ...
        Stop		 5 Feb 2016 14:45:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 5 Feb 2016 14:25:00.000000000
    ...
    BEGIN EOPFile
        ...
        InheritEOPSource		 No
        EOPFilename		 C:\Users\kdand\Documents\STK 11 (x64)\SOLISExample_Automation\EOP-v1.1.txt
    ...
    BEGIN Extensions
        ...
        BEGIN Author
            ...
            BEGIN ExternalFileList
                ...
                END File
                BEGIN File
                    Name		 "SOLISExample_Landmapper_BC STK ScenarioWB.wsp"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "SOLISExample_Landmapper_BC STK ScenarioWB.wsptb"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "SOLISExample_Landmapper_BC.sc"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "SOLISExample_Landmapper_BC.sc3"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "SOLISExample_Landmapper_BCTimelinePrefs.xml"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                ...
                END File
                BEGIN File
                    Name		 "20180123204742.mta"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "20180123204747.mta"
                    IncludeInVDF		 Yes
                END File
                BEGIN File
                    Name		 "CommOff.fj"
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                EndTime		 5 Feb 2016 14:45:00.000000000
                CurrentTime		 5 Feb 2016 14:26:07.000000000
                Direction		 Forward
                UpdateDelta		 5
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 36.34713188915958
                        CenterLongitude		 -104.8960206601701
                        ...
                        BEGIN ZoomLocations
                            ...
                            END ZoomLocation
                            BEGIN ZoomLocation
                                CenterLat		 36.34713188915958
                                CenterLon		 -104.8960206601701
                                ZoomWidth		 36.1442585773447
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/GroundStation
        ...
        Instance Target/SS3
            Target/SS3		
        END Instance
        Instance Target/Tgt1
            Target/Tgt1		
        END Instance
        Instance Target/Tgt2
            Target/Tgt2		
        END Instance
        Instance Target/Tgt3
            Target/Tgt3		
        END Instance
        Instance Target/Tgt4
            Target/Tgt4		
        END Instance
        Instance Target/Tgt5
            Target/Tgt5		
        END Instance
        Instance Target/Tgt6
            Target/Tgt6		
        END Instance
        Instance Target/Tgt7
            Target/Tgt7		
        END Instance
        Instance Target/Tgt8
            Target/Tgt8		
        END Instance
        Instance Target/Tgt9
            Target/Tgt9		
        END Instance
    END References
