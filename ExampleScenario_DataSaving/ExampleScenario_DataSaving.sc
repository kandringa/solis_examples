...
BEGIN Scenario
    Name		 ExampleScenario_DataSaving

    BEGIN Epoch

        Epoch		 1 Jun 2019 00:00:00.000000000
        SmartEpoch		
        BEGIN EVENT
            Epoch		 1 Jun 2019 00:00:00.000000000
            EventEpoch		
    ...
    BEGIN Interval
        ...
        Start		 1 Jun 2019 00:00:00.000000000
        Stop		 1 Jun 2019 00:10:00.000000000
        SmartInterval		
        BEGIN EVENTINTERVAL
            BEGIN Interval
                Start		 1 Jun 2019 00:00:00.000000000
    ...
    BEGIN Extensions
        ...
        BEGIN ClsApp
            ...
            LaunchWindowStart		 -194400
            LaunchWindowStop		 -108600
            LaunchMETOffset		 0
            ...
            BEGIN EVENTINTERVAL
                BEGIN Interval
                    Start		 29 May 2019 18:00:00.000000000
                    Stop		 30 May 2019 18:00:00.000000000
                END Interval
                IntervalState		 Explicit
            END EVENTINTERVAL
        ...
        BEGIN Desc
            BEGIN LongText
The purpose of this scenario is to excercise all possible options for saving SOLIS GUI data.  It is not intended to be a valid spacecraft configuration.  Comparing diffs of the XML saved by this scenario can be a good indicator of what has changed from one SOLIS version to the next.
            END LongText
        END Desc
...
<VAR name = "STK_RF_Environment">
    <SCOPE Class = "RFEnvironment">
        ...
        BEGIN Graphics
            ...
            BEGIN Animation
                ...
                StartTime		 1 Jun 2019 00:00:00.000000000
                EndTime		 1 Jun 2019 00:10:00.000000000
                CurrentTime		 1 Jun 2019 00:00:15.000000000
                Direction		 Forward
                UpdateDelta		 10
            ...
            BEGIN MapData
                ...
                BEGIN Map
                    ...
                    BEGIN MapAttributes
                        PrimaryBody		 Earth
                        SecondaryBody		 Sun
                        CenterLatitude		 8.89389067524116
                        CenterLongitude		 127.3891139750094
                        ...
                        BEGIN ZoomLocations
                            ...
                            END ZoomLocation
                            BEGIN ZoomLocation
                                CenterLat		 9.839228295819934
                                CenterLon		 125.9711075441413
                                ZoomWidth		 74.54253611556983
                                ZoomHeight		 52.66881028938906
                            END ZoomLocation
                            BEGIN ZoomLocation
                                CenterLat		 8.89389067524116
                                CenterLon		 127.3891139750094
                                ZoomWidth		 51.048231511254
                                ZoomHeight		 26.46945337620578
                            END ZoomLocation
                        END ZoomLocations
    ...
    BEGIN References
        Instance *
            *		
        END Instance
        Instance Facility/Facility1_AllConstraints
            Facility/Facility1_AllConstraints		
        END Instance
        ...
        Instance Facility/Facility3
            Facility/Facility3		
        END Instance
        Instance Place/Place1_MaxRng
            Place/Place1_MaxRng		
        END Instance
        Instance Place/Place2
            Place/Place2		
        END Instance
        Instance Place/Place3
            Place/Place3		
        END Instance
        Instance Satellite/HighlyConfiguredSC
            Satellite/HighlyConfiguredSC		
            Satellite/HighlyConfiguredSC/Sensor/Sensor1		
        END Instance
        Instance Satellite/HighlyConfiguredSC/Sensor/Sensor1
            Satellite/HighlyConfiguredSC/Sensor/Sensor1		
        END Instance
        Instance Satellite/PerfectControlSC
            Satellite/PerfectControlSC		
        END Instance
        Instance Target/Target1_MinEl
            Target/Target1_MinEl		
        END Instance
